    ...
    public partial class Form1 : Form
    {
        ...
        private void btnTraTu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DicAnhVietProxy.WebService1 b = new DicAnhVietProxy.WebService1();
                if (b.TraTuAnhViet(a.TraTuPhapAnh(txtTiengAnh.Text)) == " ")
                {
                    txtTiengViet.Text = "Anh - Việt Không Có";
                }
                else
                {
                    txtTiengViet.Text = b.TraTuAnhViet(a.TraTuPhapAnh(txtTiengAnh.Text));
                }
            }
